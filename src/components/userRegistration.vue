  ...
  <div class="registration-container">
    ...
    <form @submit.prevent="register" enctype="multipart/form-data" class="registration-form">
      <div class="form-group">
        ...
        <input v-model="formData.username" type="text" placeholder="Enter Username" id="username" class="form-control" required>
      </div>
      <div class="form-group">
        <label for="password" class="form-label">Password</label>
        <input v-model="formData.password" type="password" id="password" placeholder="Enter Password" class="form-control" required>
      </div>
      <div class="form-group">
        <label for="confirm" class="form-label">Confirm Password</label>
        <input v-model="formData.confirm" type="password" id="confirm" placeholder="Enter Confirm Password"  class="form-control" required>
      </div>
      <div class="form-group">
...
<style scoped>
  .registration-container {
    ...
    border-radius: 8px;
    box-shadow: 0 0 10px rgba(136, 40, 40, 1.5);
    box-shadow: 0 0 20px rgba(134, 40, 40, 1.5);
